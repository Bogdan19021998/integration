...
public class DefineSchemaQueryDefinitionMySQL extends AbstractDefineSchemaQueryDefinition {
    ...
    public DefineSchemaQueryDefinitionMySQL(String schema, String tableName) {
        this.schema = schema;
